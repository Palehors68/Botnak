...
public class GUIEmotesPHB extends JFrame {
	public GUIEmotesPHB(JTextArea userChat, GUIMain guiMain) {
		this.userChat = userChat;
		this.guiMain = guiMain;
		botnakUser = Settings.channelManager.getUser(Settings.accountManager.getUserAccount().getName(), false);
		initComponents();
	}

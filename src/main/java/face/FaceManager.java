...
//			GUIMain.log(e.getMessage());
	...
	public static void buildMap() {
		try {
			// Load twitch faces
			int q = 0;
			while (GUIMain.currentSettings.twitchClientID == null) { System.out.println(++q);}
	...
	public static void handleEmoteSet(String emotes) {
		...
		ThreadEngine.submit(() -> {
			try {
				...
				//                URL url = new URL("https://api.twitch.tv/kraken/chat/emoticon_images?emotesets=" + emotes + "&client_id=" + GUIMain.currentSettings.twitchClientID);

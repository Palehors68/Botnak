...
public class Race extends Thread {
    ...
    public void printStart() {
        Settings.accountManager.getBot().sendMessage(channel, "/me A wild Dampe race has appeared! Everybody has " + 
    ...
    public synchronized void printVoteOver() {
    	...
    	if (results.isEmpty()){
    		Settings.accountManager.getBot().sendMessage(channel, "/me Voting is now closed! Nobody guessed. Dampe wins. WinWaker");
    	} else {
	    	Guess most = results.get(0);
	    	Settings.accountManager.getBot().sendMessage(channel, "/me Voting is now closed! The most common guess was " + 
    ...
    public void judgeRace(String result){
    	...
    	if (correctGuess == null || correctGuess.count == 0) {
    		Settings.accountManager.getBot().sendMessage(channel, "/me The race finished in " + result + " seconds. Nobody guessed correctly. BibleThump");
    	} else {
    		...
    		Settings.accountManager.getBot().sendMessage(channel, sb.toString());
    	}

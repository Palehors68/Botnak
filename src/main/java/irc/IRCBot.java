...
//            	getBot().disconnect();
            	GUIMain.currentSettings.accountManager.addTask(new Task(getBot(), Task.Type.DISCONNECT, ""));
//            	GUIMain.currentSettings.accountManager.getViewer().disconnect();
            }
...
//                                getBot().sendMessage(channel, "Volume set to " + String.format("%.1f", GUIMain.currentSettings.soundVolumeGain));
                        ...
                        case HOST_USER:
                        	...
                        	int messageCount = 1;
                        	if (GUIMain.currentSettings.channelManager.getChannel(channel).isMod(getBot().getNick())) { 
                        		messageCount = 10;
